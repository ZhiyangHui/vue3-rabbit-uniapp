...
//找到选择的地址
const showAddress = ref<string>()
const findSelectedAddress = async () => {
  const addressStore = useAddressesStore()
  showAddress.value = (await addressStore.selectedAddress) || '请选择商品地址'
}
    ...
    <view class="goods">
      ...
      <view class="action">
        ...
        <view class="item arrow">
          ...
          <text @tap="openPopup('service')" class="text ellipsis"> 无忧退 快速退款 免费包邮 </text>
        </view>
      </view>
    </view>

...
import { getMemberOrderAPI } from '@/apis/order'
import { onMounted, ref } from 'vue'
import { OrderState } from '@/apis/constants'
import { orderStateList } from '@/apis/constants'
import { getPayMockAPI, getPayWxPayMiniPayAPI } from '@/apis/pay'
...
const onOrderPay = async () => {
  if (import.meta.env.DEV) {
    ...
    //正式环境的业务
    const res = await getPayMiniPayAPI({ orderId: query.id })
